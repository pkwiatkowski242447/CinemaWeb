...
import pl.pas.gr3.cinema.exceptions.managers.crud.admin.AdminManagerCreateAdminDuplicateLoginException;
...
public class AdminController implements UserServiceInterface<Admin> {
    ...
    public Response create(AdminInputDTO adminInputDTO) {
        ...
        } catch (AdminManagerCreateAdminDuplicateLoginException exception) {
