...
import pl.pas.gr3.cinema.exception.services.crud.admin.AdminServiceAdminNotFoundException;
...
import pl.pas.gr3.cinema.services.impl.AdminService;
...
public class AdminController implements IUserService<Admin> {
