...
import pl.pas.gr3.cinema.dto.output.StaffResponse;

import java.util.UUID;

@Getter @Setter
@NoArgsConstructor
public class UpdateStaffRequest extends StaffResponse {
    ...
    @JsonCreator
    @JsonbCreator
    public UpdateStaffRequest(@JsonProperty("id") @JsonbProperty("id") UUID id,
